...
- **SECTION_NAME** = [Human-readable name, e.g., "History" or "Scorecard"]
- **SECTION_ID** = [Folder name in sections/, e.g., "history" or "scorecard"]
- **NN** = [Milestone number, e.g., "02" or "06" — sections start at 02 since 01 is Foundation]
